...
const PrivacyPolicy = () => {
  return (
    <>
      <Header />
      <section className="footerPage_basic privacy_policy">
        <div className="container">
          ...
          <p>
            ...
            you, such as your name, address, email address, and telephone
            number. We collect this information when you make a reservation,
            place an order, sign up for our email list, or participate in a
            survey or contest.
          </p>
          <p>
            Non-personal information is information that cannot be used to
            identify you, such as your IP address, browser type, and location.
          ...
          <p>
            We may also use your information to comply with legal requirements,
            such as responding to a subpoena or court order.
          </p>
          <h2 className="mt-5">Sharing Your Information</h2>
          <p>
            We do not sell or rent your personal information to third parties.
            However, we may share your information with our affiliated companies
            or service providers for the purposes described above. These
            companies are contractually obligated to protect your information
            and are not permitted to use it for any other purpose.
          </p>
          <p>
            We may also be required to disclose your information in response to
            a legal request, such as a subpoena or court order, or in the event
            of a merger, acquisition, or other corporate change.
          </p>
          ...
          <p>
            ...
            from us by clicking the "unsubscribe" link in the email.
          </p>
          ...
          <p>
            ...
            access, use, or disclosure. However, no website or internet
